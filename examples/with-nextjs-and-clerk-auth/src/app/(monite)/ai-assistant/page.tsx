    ...
    <Box className="Monite-PageContainer Monite-AiAssistant">
      <Stack direction="column" sx={{ width: '100%' }}>
        ...
        <Box sx={{ mt: 6 }}>
          ...
          >
            <Typography color="rgba(0, 0, 0, 0.84)">
              This feature is currently unavailable on Sandbox. Contact our team
              to see it in action!
            </Typography>
          </Alert>
        </Box>
