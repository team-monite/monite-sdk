...
import {
  ...
  MoniteProvider as MoniteProviderComponent,
  Payables as PayablesComponent,
  Receivables as ReceivablesComponent,
  Counterparts as CounterpartsComponent,
  Products as ProductsComponent,
  ApprovalPolicies as ApprovalPoliciesComponent,
  Tags as TagsComponent,
  UserRoles as UserRolesComponent,
  RolesAndApprovalPolicies as RolesAndApprovalPoliciesComponent,
  DocumentDesign as DocumentDesignComponent,
  Onboarding as OnboardingComponent,
