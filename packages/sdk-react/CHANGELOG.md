...
- 15fd7c1: feature(DEV-9854): add table for user roles

### Patch Changes

- 15fd7c1: refactor(DEV-9443): Improved user permission support for UI
- 15fd7c1: fix(DEV-9443): Do not display output `null` in `<ApprovalPoliciesUser/>`if user name is not specified
- Updated dependencies [15fd7c1]
