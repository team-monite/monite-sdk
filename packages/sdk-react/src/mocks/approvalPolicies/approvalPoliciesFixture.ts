...
export const approvalPoliciesSearchFixture: components['schemas']['ApprovalPolicyResourceList'] =
  {
    data: [
      {
...
export const approvalPolicyByIdFixtures: Array<
  components['schemas']['ApprovalPolicyResource']
> = [
  {
    id: '2b659d98-61db-491e-9d74-901c704dd1db',
