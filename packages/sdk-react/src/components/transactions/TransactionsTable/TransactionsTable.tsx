...
export const TransactionsTable = () => {
  ...
  const {
    ...
    FilterTypes
  >({
    initialPageSize: componentSettings.transactions.pageSizeOptions[0] ?? 20,
    initialSort: {
      field: 'started_at',
      direction: 'desc',
    },
        ...
        <DataTable
          ...
          noRowsOverlay={() => (
            <GetNoRowsOverlay
              ...
              isError={!!error}
              refetch={refetch}
              entityName={t(i18n)`Transactions`}
              noDataTitle={t(i18n)`No transactions yet`}
              noDataDescription1={t(i18n)`You don't have any transactions yet`}
              noDataDescription2={t(i18n)`Your transactions will appear here`}
              filterTitle={t(i18n)`No transactions found`}
