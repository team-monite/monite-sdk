    ...
    >
      ...
      {Boolean(
        ...
        >
          ...
          {!!paymentReminderQuery.data && (
            <RemindersCard
              cardTitle={t(i18n)`Before due date`}
          ...
          {!!overdueReminderQuery.data?.terms?.length && (
            <RemindersCard
              cardTitle={t(i18n)`After due date`}
              reminderTerms={[
                {
                  termPeriodName: t(i18n)`Overdue`,
                  termPeriods: overdueReminderQuery.data.terms.map(
                    ({ days_after }) =>
                      t(i18n)`Send: ${days_after} ${plural(days_after, {
                        one: 'day',
                        two: 'days',
                        few: 'days',
                        many: 'days',
...
const createPaymentReminderCardTerms = (
  i18n: I18n,
