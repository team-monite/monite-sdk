      ...
      <Box>
        <TableContainer sx={{ maxHeight: 400 }}>
          <Table stickyHeader>
            ...
            <TableBody>
              {/* Rows from local state */}
              {rows.map((row, index) => (
                <TableRow className={tableRowClassName} key={index}>
                      ...
                      <TextField
                        ...
                        onChange={(e) => {
                          ...
                          setRows((prevRows) => {
                            ...
                            newRows[index].quantity = newQuantity;
                            return newRows;
                          });
                        }}
                      />
                      {row.measure_unit_id ? (
                        <MeasureUnit unitId={row.measure_unit_id} />
                      ) : (
                        'notloaded'
                      )}
                    </FormControl>
                      ...
                      <TextField
                        ...
                        onChange={(e) => {
                          ...
                          if (!isNaN(newValue)) {
                            setRows((prevRows) => {
                              const newRows = [...prevRows];
                              newRows[index].price.value = newValue;
                              return newRows;
                            });
                          }
                        }}
                    ...
                    {isNonVatSupported ? (
                      ...
                      >
                        <TextField
                          ...
                          sx={{ minWidth: 100 }}
                          value={row.tax_rate_value}
                          onChange={(e) => {
                            const newTaxRate = parseFloat(e.target.value);
                            setRows((prevRows) => {
                              const newRows = [...prevRows];
                              newRows[index].tax_rate_value = newTaxRate;
                              return newRows;
                            });
                          }}
                        />
