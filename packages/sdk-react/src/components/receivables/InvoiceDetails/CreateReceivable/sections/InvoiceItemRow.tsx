...
import { ItemSelector, ProductItem } from './components/Items/ItemSelector';
import { PriceField } from './components/Items/PriceField';
import { QuantityField } from './components/Items/QuantityField';
import { TaxRateField } from './components/Items/TaxRateField';
import { VatRateField } from './components/Items/VatRateField';
...
interface InvoiceItemRowProps {
  ...
  onRequestLineItemValidation?: (fieldPathSuffix?: string) => void;
...
const InvoiceItemRowComponent: React.FC<InvoiceItemRowProps> = ({
  field,
  index,
  control,
  errors,
