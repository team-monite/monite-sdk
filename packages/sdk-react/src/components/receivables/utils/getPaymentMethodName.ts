...
export type PaymentMethod = components['schemas']['PaymentIntentResponse']['selected_payment_method'];

export const getPaymentMethodName = (paymentMethod: PaymentMethod, i18n: I18n) => {
