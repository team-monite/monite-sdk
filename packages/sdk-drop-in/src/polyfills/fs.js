export const promises = {
  readFile: () =>
    Promise.reject(new Error('fs.readFile not available in browser')),
  writeFile: () =>
    Promise.reject(new Error('fs.writeFile not available in browser')),
  ...
  readdir: () =>
    Promise.reject(new Error('fs.readdir not available in browser')),
};
