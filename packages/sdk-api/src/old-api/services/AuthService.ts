...
/** Endpoint to create new access token */
export const AUTH_TOKEN_ENDPOINT = 'auth/token';

/** Endpoint to revoke an existing token immediately */
export const AUTH_REVOKE_ENDPOINT = 'auth/token';
...
export class AuthService extends CommonService {
   ...
   *
   *
   * @see {@link https://docs.monite.com/reference/post_auth_revoke} for API calls
   *
   ...
   *
   * @param requestBody {ObtainTokenPayload} Obtain token payload
   *
   * @see {@link https://docs.monite.com/reference/post_auth_token} for API calls
   *
