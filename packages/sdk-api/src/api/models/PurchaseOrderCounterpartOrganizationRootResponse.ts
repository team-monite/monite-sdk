...
import type { PurchaseOrderCounterpartOrganizationResponse } from './PurchaseOrderCounterpartOrganizationResponse';

/**
 * Represents counterparts that are organizations (juridical persons).
 */
export type PurchaseOrderCounterpartOrganizationRootResponse = {
  /**
