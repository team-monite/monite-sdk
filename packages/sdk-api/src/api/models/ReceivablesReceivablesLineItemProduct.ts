...
import type { ReceivablesUnitResponse } from './ReceivablesUnitResponse';
import type { ReceivablesVatRateResponse } from './ReceivablesVatRateResponse';

export type ReceivablesReceivablesLineItemProduct = {
    /**
     * Name of the product.
     */
    name: string;
     ...
     */
    updated_at: string;
    vat_rate: ReceivablesVatRateResponse;
    measure_unit: ReceivablesUnitResponse;
};
