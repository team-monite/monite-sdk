...
import type { ReceivablesQuoteStateEnum } from './ReceivablesQuoteStateEnum';
...
export type ReceivablesQuoteResponsePayload = {
    /**
     * The type of the document uploaded.
     */
    type: ReceivablesQuoteResponsePayload.type;
    /**
     ...
     */
    status: ReceivablesQuoteStateEnum;
};

export namespace ReceivablesQuoteResponsePayload {
