...
/* eslint-disable */
import type { package__entities__unversioned__schemas__file_saver__PageSchema } from './package__entities__unversioned__schemas__file_saver__PageSchema';
import type { package__entities__unversioned__schemas__file_saver__PreviewSchema } from './package__entities__unversioned__schemas__file_saver__PreviewSchema';

/**
 * Represents a file (such as a PDF invoice) that was uploaded to Monite.
 */
export type package__entities__unversioned__schemas__file_saver__FileSchema = {
  /**
   ...
   */
  pages?: Array<package__entities__unversioned__schemas__file_saver__PageSchema>;
  /**
   * Preview images generated for this file. There can be multiple images with different sizes.
   */
  previews?: Array<package__entities__unversioned__schemas__file_saver__PreviewSchema>;
  /**
