...
export type ReceivablesReceivableFacadeCreateInvoicePayload = {
    /**
     * The type of the document uploaded.
     */
    type: ReceivablesReceivableFacadeCreateInvoicePayload.type;
...
export namespace ReceivablesReceivableFacadeCreateInvoicePayload {
